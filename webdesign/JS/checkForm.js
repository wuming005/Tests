...
if(document.register.regName.value==""){
	alert("真实姓名不能为空！");
	document.register.regName.focus();
	return false;}

if (!/([\u4e00-\u9fa5]{2,4})/.test(document.register.regName.value)){	//利用正则表达式对Email格式进行判断
...
if(fisrtL<97 || fisrtL>123){
	...
	document.register.regID.focus();
	return false;}
if(document.register.initial.value==""){
	alert("密码不能为空！");
	document.register.initial.focus();
	return false;}
if(document.register.initial.value!=document.register.verify.value){
